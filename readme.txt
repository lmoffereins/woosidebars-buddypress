...
You can download and install WooSidebars For BuddyPress using the built in WordPress plugin installer. If you download WooSidebars For BuddyPress manually, make sure it is uploaded to "/wp-content/plugins/woosidebars-buddypress/".
